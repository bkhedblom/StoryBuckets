...
namespace StoryBuckets.Services.Tests
{
    ...
    public class BucketServiceTests
    {
        ...
        [TestMethod()]
        public async Task GetAllLinked_returns_LinkedBuckets()
        {
            //Arrange
            var dataStore = new Mock<IDataStore<Bucket>>();
            dataStore
            ...
            //Act
            var result = await service.GetAllLinkedAsync();
        ...
        [TestMethod()]
        public async Task GetAllLinked_gets_buckets_From_datastore()
        {
            //Arrange
            var dataStore = new Mock<IDataStore<Bucket>>();
            ...
            //Act
            _ = await service.GetAllLinkedAsync();
        ...
        [TestMethod()]
        public async Task GetAllLinked_puts_buckets_from_datastore_into_the_linked_collection()
        {
            //Arrange
            var buckets = new[]
            {
        ...
        [TestMethod()]
        public async Task If_DataStore_is_not_initialized_GetAllLinked_initializes_it()
        {
            //Arrange
            var dataStore = new Mock<IDataStore<Bucket>>();
            dataStore
