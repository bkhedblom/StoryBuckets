...
namespace StoryBuckets.Client.Components.BucketWrapper.Tests
{
    ...
    public class BucketWrapperTests
    {
        ...
        public async Task Clicking_choose_triggers_chosen_eventAsync()
        {
            ...
            var bucket = new Mock<IBucketModel>().Object;
            var eventhandler = new Mock<IHandleEvent>();

#pragma warning disable BL0005 // Component parameter should not be set outside of its component.
            component.Bucket = bucket;
            component.OnChosen = new EventCallback<IBucketModel>(eventhandler.Object, null);
#pragma warning restore BL0005 // Component parameter should not be set outside of its component.
        ...
        public async Task Clicking_choose_sends_contained_bucket_to_event_handler()
        {
            ...
            var component = new BucketWrapper();
            var bucket = new Mock<IBucketModel>().Object;
            IBucketModel bucketSentToEvent = null;
            var eventhandler = new Mock<IHandleEvent>();
            eventhandler
                .Setup(mock => mock.HandleEventAsync(It.IsAny<EventCallbackWorkItem>(), It.IsAny<IBucketModel>()))
                .Callback((EventCallbackWorkItem _, object b) => bucketSentToEvent = b as IBucketModel);
